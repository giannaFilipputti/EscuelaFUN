...
class Examen
{
	...
	public function getCertificadoValido($clave)
	{
		...
		$sql = "SELECT com_alumnos_exam.*, com_registro.nombre, com_registro.ape1, com_registro.ape2, com_cursos_2022.titulo, com_cursos_2022.horas  FROM com_alumnos_exam INNER JOIN com_registro ON com_registro.id = com_alumnos_exam.alumno INNER JOIN com_cursos_mod ON com_alumnos_exam.modulo = com_cursos_mod.id INNER JOIN com_cursos_2022 ON com_cursos_2022.id=com_cursos_mod.curso WHERE com_alumnos_exam.clave=:clave";
