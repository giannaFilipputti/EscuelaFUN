...
echo "<br><br>";*/
	...
	static function verificarAsistencia($modulo, $email)
	{
		$db = Db::getInstance();
		$sql = "SELECT duracion FROM com_eventos_asistencia WHERE modulo = :modulo AND email = :email";
		$bind = array(
			':modulo' => $modulo,
			':email' => $email
		);
