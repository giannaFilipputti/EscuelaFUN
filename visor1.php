                        ...
                        <?php foreach ($modulos as $Elem) { 
                            ...
                            <li <?php if ($modulo == $Elem['id']) {  ?> class="uk-open"<?php  } ?>>
                                ...
                                <div class="uk-accordion-content">
                                    <!-- course-video-list -->
                                    <ul class="course-video-list-2<?php if ($modulo == $Elem['id']) {  ?> highlight-watched<?php  } ?>">
                                    <?php foreach ($capitulos as $Elem1) {  
                                        $visita = $cap->checkVisita($authj->rowff['id'], $Elem1['id']);
                                        ?>
                                        <li class="<?php if ($visita > 0) {  ?>watched<?php  } ?><?php if ($capitulo == $Elem1['id']) {  ?> uk-active<?php  } ?>"> <a href="visor.php?curso=<?php echo $Elem['curso']; ?>&modulo=<?php echo $Elem['id']; ?>&capitulo=<?php echo $Elem1['id']; ?>"> <?php echo  $Elem1['titulo']; ?> <span> </span> </a> </li>
                                    <?php $contador ++;
                                } ?>
                                ...
                                <?php if ($contador > 0) {  ?>
                                    ...
                                    <?php } else {  ?>
                                        <li><a href="#"?>Contenido disponible a<br>partir del lunes 26 de Octubre </li>
                                    <?php } ?>    
                                </ul>
                                </div>
                            </li>
                            ...
                            <ul class="course-video-list highlight-watched">
                                        ...
                                        <li><a href="#"?>Contenido disponible a<br>partir del viernes 23 de Octubre </li>
