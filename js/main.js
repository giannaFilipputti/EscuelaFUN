(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='index.html' class='logo-mobile-menu'><img src='img/logoind_mobile.png?v=1' /></a>" });
    ...
    /*-------------------------------------
     ...
     -------------------------------------*/
    if ($('#registro select.select2').length) {
        $('#registro select.select2').select2({
            theme: 'classic',
    ...
    if (contactForm.length) {
        contactForm.validator().on('submit', function(e) {
            ...
            if (e.isDefaultPrevented()) {
                target.html("<div class='alert alert-danger'><p>Completa todos los campos.</p></div>");
            } else {
                $.ajax({
                    ...
                    success: function(text) {
                        if (text === "success") {
                            _this[0].reset();
                            target.html("<div class='alert alert-success'><p><i class='fa fa-check' aria-hidden='true'></i>Mensaje ha sido enviado. En breve le responderemos.</p></div>");
                        } else {
