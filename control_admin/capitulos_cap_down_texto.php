...
<body class="twoColLiqLtHdr">
    ...
    <div id="container"> 
      ...
      <!-- DESDE AQUI CONTENIDO -->
        <h1>Descargas texto para la busqueda de descarga del capitulo: <?php echo $row['nombre'];?></h1>
        <div class="box">
        <h2>Agregar texto para buscador</h2>
        
        <form action="capitulos_cap_down_texto1.php?id=<?php echo $id;?>&ref=<?php echo $ref;?>" method="post">
