...
$sql = "SELECT * FROM com_contenidos WHERE id=".$id."";
...
<body class="twoColLiqLtHdr">
    ...
    <div id="container"> 
      ...
      <!-- DESDE AQUI CONTENIDO -->
        <h1>Contenidos: <?php echo $rowc['titulo'];?></h1>
        <div class="box">
        <h2>Modificar Contenido al curso </h2>
        <form method="POST" action="contenidos_mod1.php?id=<?php echo $id?>&ref=<?php echo $ref;?>">
        <label><span>Nombre: </span>
          <input type="text" name="titulo" size="20" value="<?php echo $row['titulo']?>"></label>
          <label><span>En menu: </span>
          <input name="menu" type="checkbox" value="1"<?php if ($row['menu'] == 1) {?> checked="checked"<?php } ?> /></label>
