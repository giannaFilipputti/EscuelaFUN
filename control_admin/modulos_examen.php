...
<body class="twoColLiqLtHdr">
    ...
    <div id="container"> 
      ...
      <!-- DESDE AQUI CONTENIDO -->
        <h1>Descarga del módulo: <?php echo $row['titulo'];?> del curso: <?php echo $row0['titulo'];?></h1>
        <div class="box">
        ...
        'script'    : '<?php echo $baseURL;?>pdf/uploadifyE.php',
		...
		onAllComplete: function (event, queueID, fileObj, response, data) {
			//alert(data);
			$.post("modulos_examen_descargas.php?id=<?=$id?>",   function(data1){            
  ...
  <div id="imagenes"><? include('modulos_examen_descargas.php') ;?>
        </div>
