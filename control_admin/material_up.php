...
<body class="twoColLiqLtHdr">
    ...
    <div id="container"> 
      ...
      <!-- DESDE AQUI CONTENIDO -->
        ...
        'script'    : '<?php echo $baseURL;?>material/uploadify_pdf.php',
		...
		onAllComplete: function (event, queueID, fileObj, response, data) {
			//alert(data);
			$.post("materiales_up_listado.php?id=<?=$id?>",   function(data1){            
        ...
        <div id="imagenes_asi"><? include('materiales_up_listado.php') ;?></div>
