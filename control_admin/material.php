...
<body class="twoColLiqLtHdr">
    ...
    <div id="container"> 
      ...
      <!-- DESDE AQUI CONTENIDO -->
        <h1>Documentaci&oacute;n Complementaria: <?php echo $curso->row[0]['titulo'];?></h1>
        <div class="box">
        <h2>Agregar Documentaci&oacute;n Complementaria al curso </h2>
        ...
        <div id="imagenes">
        <h2>Material de Vista (<a href="material_texto.php?id=<?php echo $id?>">Actualizar textos para buscador</a>)</h2>
        <?php include('material_listado.php');?>
