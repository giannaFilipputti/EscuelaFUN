...
<body class="twoColLiqLtHdr">
    ...
    <div id="container"> 
      ...
      <!-- DESDE AQUI CONTENIDO -->
        <h1>Imagen del módulo: <?php echo $row['titulo'];?> del curso: <?php echo $row0['titulo'];?></h1>
        <div class="box">
        <input type="hidden" id="esp_titulo" value="1" />
        <h2>Agregar imagen del módulo </h2>
        ...
        'script'    : '<?php echo $baseURL;?>uploads/modulo_imagen.php',
        'cancelImg' : '<?php echo $baseURL;?>plugins/uploadify/cancel.png',
        'folder': '<?php echo $baseURL;?>uploads',
		'multi': false,
		'buttonText'  : 'Seleccionar Archivo',
	    'fileExt'     : '*.jpg;*.JPG;*.GIF;*.gif;*.png;*.PNG;*.jpeg;*.JPEG',
		'method' : 'post',
		...
		onAllComplete: function (event, queueID, fileObj, response, data) {
			//alert(data);
			$.post("modulos_imagen_lista.php?id=<?=$id?>",   function(data1){            
  ...
  <div id="imagenes"><? include('modulos_imagen_lista.php') ;?>
        </div>
