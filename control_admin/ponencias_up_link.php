    ...
    <div id="container"> 
      ...
      <!-- DESDE AQUI CONTENIDO -->
        <h1> Ponencias Links </h1>
         ...
         <img border="0" class="img_ponencias" src="<?php echo $baseURL;?>uploads/ponencias/<?php echo $diapositiva->row[0]['ponencia']?>/<?php echo $diapositiva->row[0]['nombre']?>?id=<?=mt_rand(0,5)?>" width="350" /><br /><?php echo $diapositiva->row[0]['nombre']?>
       ...
       <?php }  ?>
        ...
        <div class="box">
         <div>
         <form action="ponencias_up_link_add.php?imagen=<?php echo $id?>" method="post">
          <label><span>Url: </span><input type="text" name="url" id="url" /></label>
          <label><span>Top: </span><input type="text" name="top" id="top" /> %</label>
          <label><span>Left: </span><input type="text" name="left" id="left" /> %</label>
        ...
        <div id="imagenes1">
		    ...
		    <?php include('ponencias_img1_link.php') ;?>
