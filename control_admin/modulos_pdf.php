...
<body class="twoColLiqLtHdr">
    ...
    <div id="container"> 
      ...
      <!-- DESDE AQUI CONTENIDO -->
        <h1>Descarga del módulo: <?php echo $mod->row[0]['titulo'];?> del curso: <?php echo $curso->row[0]['titulo'];?></h1>
        <div class="box">
        <input type="hidden" id="esp_titulo" value="1" />
        <h2>Agregar PDF de descarga al módulo </h2>
        ...
        'script'    : '<?php echo $baseURL;?>pdf/uploadifyM.php',
		...
		onAllComplete: function (event, queueID, fileObj, response, data) {
			//alert(data);
			$.post("modulos_pdf_descargas.php?id=<?=$id?>",   function(data1){            
  ...
  <div id="imagenes"><?php include('modulos_pdf_descargas.php') ;?>
        </div>
