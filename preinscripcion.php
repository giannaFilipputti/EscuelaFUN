...
<h1 class="h3 mb-2 text-gray-800">Pre-inscripción Escuela de Especialización en Deportes Acuáticos</h1>

<p class="mb-4">Por favor ingrese sus datos para el proceso de pre-inscripción del Ciclo de Capacitaciones 2022.</p>
	...
	<div class="row">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="form-group">
                            <select class="form-control" name="tipo_alumno" id="tipo_alumno">
                                ...
                                <option value="2" selected>Afiliado a Club FECHIDA (Descuento 20%)</option>
                                <option value="3">Estudiante (Descuento 15%)</option>
                            </select>
		...
		<div class="col-lg-12">
			...
			<div class="card shadow mb-4">
                ...
                <h6 class="m-0 font-weight-bold text-primary">Selecciones el(los) cursos en los que estaría interesado</h6>
