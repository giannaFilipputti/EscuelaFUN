    ...
    <div id="wrapper" class="bg-white">
        ...
        <div class="page-content">
            ...
            <div class="page-content-inner">
                ...
                <?php if ($asistencia == "OK") {

                    //echo $rut;
                    if (!empty($rut)) {
                        $usuario = Alumno::existeUsuarioDNI($rut);
                    } else {
                        $usuario = "";
                    }

                    if (empty($usuario) && !empty($email)) {
                        $usuario = Alumno::existeUsuario($email);
                    }
                ...
                ?>
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <?php if (!empty($usuario)) { ?>
                            Bienvenido <?php echo $usuario['nombre'] . " " . $usuario['ape1'] . " " . $usuario['ape2'] ?><br>
                            Asistencia registrada. Muchas gracias
                        <?php } else { ?>
                            Asistencia registrada. <br>
                            Su rut no está registrado en nuestra base de datos, es necesario registrarse para obtener su certificado al finalizar el ciclo de capacitaciones presenciales.<br>
                            <a href="registro.php" class="uk-width-1-1 transition-3d-hover btn btn-success">Registrar usuario</a>
                        <?php } ?>
                ...
                <h4 class="mt-lg-7 mt-4">Próximas capacitaciones Presenciales</h4>
                <?php if (!empty($escuela)) { ?>
                    ...
                    <div class="uk-child-width-1-2@s uk-child-width-1-4@m" uk-grid>
                        ...
                        <?php
                        $preinscr = 0;
                        foreach ($cursosE as $Elem) {
                            $mensajeInscr = "";
                            $cursoE = 0;
                            $porc_curso = 0;

                            $inscrito = Presenciales::getInscritoCurso($Elem['id'], $authj->rowff['id']);
                            if ($inscrito == 0) {
                                $link_mod = "clinica_det.php?id=" . $Elem['id'];
                                $clase_mod = "";
                            } else {
                                /*
                    $link_mod = "#";
                            ...
                            <div>
                                ...
                                <a href="<?php echo $link_mod ?>">
                                    <div class="course-path-card <?php echo $clase_mod ?>">
                                        <img src="assets/images/clinica/<?php echo $Elem['id'] ?>.png?v=11" alt="">
                    ...
                    */
                        ...
                        ?>
                            ...
                            <div>
                                ...
                                <a href="<?php echo $link_mod ?>">
                                    <div class="course-path-card <?php echo $clase_mod ?>">
                                        <img src="assets/images/clinica/<?php echo $Elem['id'] ?>.png?v=10" alt="">
                                        <div class="course-path-card-contents">
                                            <h3> <?php echo $Elem['titulo'] ?> </h3>
                                            <!--<p> <?php echo $Elem['descripcion'] ?>
                                </p>-->
                    ...
                    */
                        ...
                        ?>
                            ...
                            <div>
                                ...
                                <a href="<?php echo $link_mod ?>">
                                    <div class="course-path-card <?php echo $clase_mod ?>">
                                        <img src="../assets/images/course/<?php echo $Elem['id'] ?>.jpg?v=10" alt="">
                                        <div class="course-path-card-contents">
                                            <h3> <?php echo $Elem['titulo'] ?> </h3>
                                            <!--<p> <?php echo $Elem['descripcion'] ?>
                                </p>-->
                                            ...
                                            <p class="<?php if ($cursoE == 1) { ?>bg-gradient-success shadow-success uk-light uk-alert intermitente<?php } else if ($cursoE == 2) { ?>bg-gradient-warning shadow-warning uk-light uk-alert intermitente<?php } else { ?>bg-gradient-primary shadow-primary uk-light uk-alert<?php } ?>"><strong><span class="blanco"><?php if (date("Y/m/d", strtotime($Elem['fecha'])) <= date("Y/m/d")) { ?>Curso Activo<?php } else { ?>Inicio: <?php echo date("d/m/Y", strtotime($Elem['fecha'])) ?><?php } ?><?php if (!empty($mensajeInscr)) { ?> - <?php } ?> <?php echo $mensajeInscr; ?> </span></strong></p>
                                            <div class="course-progressbar mt-3">
                                                <div class="course-progressbar-filler" title="Visualizado <?php echo $porc_curso; ?>% del curso" style="width:<?php echo $porc_curso; ?>%"></div>
                                            </div>
                        ...
                        <!--<p><img src="assets/images/clinica/financiamiento.jpg?v=6" alt="" style="max-width: 300px;"></p>-->
                ...
                <div id="modal-example" uk-modal>
                    <div class="uk-modal-dialog uk-modal-body">
                        ...
                        <p>Ud. tiene <?php echo $preinscr; ?> curso(s) preinscrito(s).<br> Para finalizar su inscripción debe acceder a:<br>
                            <a href="clinica_basket.php" class="btn btn-success"> <i
