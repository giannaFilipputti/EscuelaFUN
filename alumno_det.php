...
$alum = new Alumno();
$alumno = $alum->getOne($id);
//print_r($alumno);

$cursos = Curso::getCursosPreinscritos($id);
                        ...
                        <div class="profile-cards" uk-sticky="offset: 90; bottom: true; media: @m;top:2">
                            ...
                            <div id="user_foto" class="user-profile-photo">
                                ...
                                ?>
                                    ...
                                    <img src="uploads/g_perfil_<?php echo $alumno['id']; ?>_<?php echo $alumno['foto_perfil']; ?>.jpg" alt="">
                                <?php } else { ?>
                                    <img src="../assets/images/avatars/home-profile.jpg?v=1" alt="">
                                <?php } ?>
                            </div>

                            <h4> <?php echo $alumno['nombre'] . " " . $alumno['ape1'] . " " . $alumno['ape2']  ?> </h4>
                                ...
                                <div class="shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="pais_alumno" id="pais_alumno" required="required">
                                                    ...
                                                    foreach ($paises as $row) :
                                                        ...
                                                        <option value="<?php echo $id; ?>" <?php if ($row['id'] == $alumno['pais']) { ?> selected<?php } ?>><?php echo $pais; ?></option>
                                                    <?php
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="telf_alumno" id="telf_alumno" required="required" value="<?php echo $alumno['telefono']; ?>">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <select class="form-control" name="genero_alumno" id="genero_alumno" required="required">
                                                    ...
                                                    <option value="F" <?php if ($alumno['genero'] == 'F') {
                                                                            echo " selected";
                                                                        } ?>>Femenino</option>
                                                    <option value="M" <?php if ($alumno['genero'] == 'M') {
                                                                            echo " selected";
                                                                        } ?>>Masculino</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <input type="date" name="fecnac_alumno" id="fecnac_alumno" required="required" value="<?php echo $alumno['fecnac']; ?>" onclick="this.value = '2000-01-01';" />
                                            ...
                                            <div id="div_tipo">
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control" name="tipo_alumno" id="tipo_alumno">
                                                        ...
                                                        <option value="2" <?php if ($alumno['tipouser'] == 2) { ?> selected<?php } ?>>Afiliado a Club FECHIDA (Descuento 20%)</option>
                                                        <option value="3" <?php if ($alumno['tipouser'] == 3) { ?> selected<?php } ?>>Estudiante (Descuento 15%)</option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="club_alumno" id="club_alumno" value="<?php echo $alumno['club']; ?>">
                                            </div>
                                            ...
                                            <ul>
                                                ...
                                                <?php foreach ($cursos as $curso) {
                                                    ...
                                                    if ($curso['estadopago'] >= 2) {
                                                        $estadopago = "Pagado";
                                                    }
                                                    $estadoT = $estado . " " . $estadopago;
                                                    if (empty($estadoT)) {
                                                        $estadoT = "Preinscrito";
                                                    }
                                                ...
                                                ?>
                                                    ...
                                                    <li><?php echo $curso['titulo'] . " " . $curso['ciclo'] . " (" . $estadoT . ")" ?></li>
