                            ...
                            <?php foreach ($modulos as $Elem) { 
                                ...
                                <li>
                                    ...
                                    <div class="uk-accordion-content">
                                        ...
                                        <li><?php echo  $Elem1['titulo'] ?> <span> <?php echo  $Elem1['autor'] ?></span><a href="visor.php?curso=<?php echo $id ?>&modulo=<?php echo  $Elem['id'] ?>&capitulo=<?php echo  $Elem1['id'] ?>">Ver<a style="color: white;"><?php echo $Elem1['revista']; ?></a></a>
