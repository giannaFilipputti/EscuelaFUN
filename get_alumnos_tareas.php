...
$sql = "SELECT ANY_VALUE(com_registro.id) as id,
               CONCAT(COALESCE(com_registro.nombre,''),' ',
               COALESCE(com_registro.ape1,''),' ',
               COALESCE(com_registro.ape2,'')) as alumno,
               ANY_VALUE(com_tareas_archivos.ruta) as subida,
               ANY_VALUE(com_tareas_archivos.fecha_subida) as fecha_subida,
