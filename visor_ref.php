                        ...
                        <div class="dropdown-option-nav " uk-dropdown="pos: bottom-right ;mode : click">
                            <ul>
                                ...
                                <li><a href="miscursos.php">
                                        ...
                                        Ver Mis Cursos </a></li>
                                <li><a href="modulos.php?id=<?php echo $ocurso; ?>">
                                        <i class="icon-material-outline-arrow-back"></i>
            ...
            <div class="course-sidebar">
                ...
                <ul id="course-intro-tab" class="uk-switcher mt-4">
                                            ...
                                            <ul class="course-video-list<?php if ($modulo == $Elem['id']) {  ?> highlight-watched<?php  } ?>">
                                                ...
                                                ?>
                                                    <li class="<?php if ($visita > 95) {  ?>watched<?php  } ?><?php if ($capitulo == $Elem1['id']) {  ?> uk-active<?php  } ?>">
                                                        ...
                                                        if ($ctl_ant == 0) {
                                                            $vinculo_ant = "visor_ref.php?curso=" . $Elem['curso'] . "&modulo=" . $Elem['id'] . "&capitulo=" . $Elem1['id'];
                                                        }
                                                        if ($ctl_sig == 1) {
                                                            $vinculo_sig = "visor_ref.php?curso=" . $Elem['curso'] . "&modulo=" . $Elem['id'] . "&capitulo=" . $Elem1['id'];
                                                            $ctl_sig = 0;
                                                        }
                                                        if ($capitulo == $Elem1['id']) {
                                                            $ctl_sig = 1;
                                                        ...
                                                        ?>
                                                        <a href="visor_ref.php?curso=<?php echo $Elem['curso']; ?>&modulo=<?php echo $Elem['id']; ?>&capitulo=<?php echo $Elem1['id']; ?>">
                                                        ...
                                                        ?>
                                                            ...
                                                            <button type="button" class="agregar_tarea visor_ref.php btn-primary btn-sm" href="#modal_tarea" uk-toggle="" data-curso="<?php echo $Elem['curso']; ?>" data-modulo="<?php echo $Elem['id']; ?>" data-capitulo="<?php echo $Elem1['id']; ?>">
                                                                Crear tarea
                    ...
                    <?php } ?>
                            ...
                            <a href="visor.php?curso=<?php echo $ocurso?>&modulo=<?php echo $omodulo?>&capitulo=<?php echo $ocapitulo?>" id="btn_curso" href="#" class="btn btn-success btn-sm">Volver al Curso</a>
                            </div>
