        ...
        foreach($_FILES['files'] as $v=>$file) {
            ...
            if(in_array($file_ext,$extensions) === false){
                ...
                if(move_uploaded_file($file_tmp, "uploads/tareas/" . $nombre_archivo)){
                    ...
                    $query = "INSERT INTO com_tareas_archivos (usuario,curso,modulo,capitulo,ruta,fecha_subida)
                                VALUES ($id_usuario,$id_curso,$id_modulo,$id_capitulo,'uploads/tareas/$nombre_archivo','$fecha_subida')";
                    $db->run($query);
