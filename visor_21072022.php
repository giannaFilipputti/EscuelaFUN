...
if (date("Y-m-d", strtotime($cursos[0]['fecha'])) > date('Y-m-d')) {
    header("location: cursos.php");
    die();
}
    ...
    <div id="wrapper">
        ...
        <div class="course-layouts">
            ...
            <div class="course-content bg-dark">
                        ...
                        <div class="dropdown-option-nav " uk-dropdown="pos: bottom-right ;mode : click">
                            <ul>
                                ...
                                <li><a href="miscursos.php">
                                        ...
                                        Ver Mis Cursos </a></li>
                                <li><a href="modulos.php?id=<?php echo $modulo; ?>">
                                        <i class="icon-material-outline-arrow-back"></i>
                ...
                <div style="padding-right: 50px;" class="text-right">
                    <a class="btn_ant btn btn-primary btn-sm">Anterior</a>&nbsp;<a class="btn_sig btn btn-primary btn-sm">Siguiente</a>
                </div>
            ...
            <div class="course-sidebar">
                ...
                <nav class="responsive-tab style-5">
                    <ul uk-switcher="connect: #course-intro-tab ;animation: uk-animation-slide-right-medium, uk-animation-slide-left-medium">
                        ...
                        <li><a href="#">Notas (<?php echo $cant_Notas; ?>)</a></li>
                        <?php if ($cant_desc > 0) { ?>
                        <li><a href="#">Descargas (<?php echo $cant_desc; ?>)</a></li>
                        <?php } ?>
                    </ul>
                </nav>
                ...
                <ul id="course-intro-tab" class="uk-switcher mt-4">
                    ...
                    <li>
                        <div class="course-sidebar-title d-flex justify-content-center">
                            <button type="button" class="comentario_principal btn btn-danger" id="add_nota">
                                Agregar Nota <span class="min-nota"></span>
                            </button>
                        </div>
                        <div class="course-sidebar-container" data-simplebar>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            player1.on('timeupdate', function(data) {
                ...
                if (tiempopass == data.percent) {} else {
                    // console.log('Percentage watched: ' + data.percent + 'tiempopass ' + tiempopass);
                    tiempoact = data.percent * 100;
                    tiempoact = tiempoact.toFixed(2);
