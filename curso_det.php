                                            ...
                                            <div class="uk-accordion-content">
                                                ...
                                                <ul class="course-curriculum-list">
                                                    ...
                                                    <?php foreach ($capitulos as $Elem1) {  ?>
                                                        ...
                                                        <li><?php echo  $Elem1['titulo'] ?> <span> <?php //echo  $Elem1['autor'] 
                                                                                                    ?></span>
                            ...
                            <div id="trailer-modal" uk-modal>
                                <div class="uk-modal-dialog">
                                    ...
                                    <div class="video-responsive">
                                        ...
                                        <iframe src="https://player.vimeo.com/video/<?php echo $cursos[0]['promocion'] ?>" class="uk-padding-remove" uk-video="automute: false" width="640" height="360" frameborder="0" allowfullscreen uk-responsive></iframe>
                            ...
                            <div class="p-3">
                                ...
                                ?>
                                            <?php if (date("Y-m-d", strtotime($cursos[0]['fecha'])) <= date('Y-m-d')) { ?>
                                                <p class="bg-gradient-success shadow-success uk-light uk-alert intermitente blanco"><a href="modulos.php?id=<?php echo $id; ?>">ENTRAR AL CURSO</a></p>
                                        ...
                                        <?php } else if ($inscrito[0]['estadopago'] == 0) {  ?>
                                            <div>
                                                <a href="curso_basket.php">
                                                    <p class="bg-gradient-warning shadow-warning uk-light uk-alert intermitente blanco"><span class="blanco"><i class="uil-play"></i> Formalizar inscripción</span></p>
                                                </a>
                                                <!--
                                        <a href="curso_basket.php"
                                        ...
                                        <?php } else if ($inscrito[0]['estadopago'] == 2 && $inscrito[0]['validprerequisitos'] == 0) {  ?>
                                            ...
                                            <div>
                                                <a href="curso_prerequisitos.php" class="uk-width-1-1 btn btn-default transition-3d-hover"> <i class="uil-play"></i> Acreditar pre-requisitos </a>
                                            </div>
                                ...
                                <div class="uk-child-width-1-1 uk-grid-small mb-4" uk-grid>
                                    ...
                                    if ($authj->logueado == 0 && $cursos[0]['insc_abierta'] == 1) {  ?>
                                        <div>
                                            <a href="login.php?curso=<?php echo $cursos[0]['id'] ?>" class="uk-width-1-1 btn btn-default transition-3d-hover"> <i class="uil-play"></i> Inscribirse </a>
                                        </div>
                                    <?php } else if (!is_array($inscrito) && $cursos[0]['insc_abierta'] == 1) { ?>

                                        <div>
                                            <a href="curso_inscribir.php?id=<?php echo $cursos[0]['id'] ?>" class="uk-width-1-1 btn btn-default transition-3d-hover"> <i class="uil-play"></i> Inscribirse </a>
                                        </div>
                                    <?php } else if ($cursos[0]['insc_abierta'] == 0) { ?>
