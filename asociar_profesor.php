	...
	<div class="row">
		...
		<div class="col-lg-4">
			...
			<div class="shadow mb-4">
				...
				<h6 class="m-0 font-weight-bold text-primary">Seleccionar profesor</h6>

				</div>

                <div class="card-body">

                    <span class="icon text-gray-600">Profesor</span>
        ...
        <div class="col-lg-8">
			...
			<div class="card shadow mb-4">
                ...
                <h6 class="m-0 font-weight-bold text-primary">Cursos sin profesor asignado</h6>
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result3 == ""){
                    ...
                    result3.forEach( function(valor, indice, array) {
                        var html = 
                    ...
                    $('#cursos_disponibles').append("<button onclick='add_profesor_curso()' class='uk-button uk-button-primary uk-button-large' id='btn_asociar'>Asignar profesor/s</button>");
...
<script type="text/javascript">
    ...
    function add_profesor_curso(){

        var jsonString = JSON.stringify(cursos_usuarios);

        if(jsonString == "[]"){

            alert("ERROR. No ha seleccionado ningún curso para asignar al profesor.");

        }else{

            $.ajax({
                type: "POST",
                url: "add_profesor_curso.php",
                dataType : 'json',
                data: {
                    data : jsonString,
                ...
                success: function(result){
                    ...
                    console.log("add_profesor_curso:",result);
                    
                    if(result.success){
                        
                        alert("Profesor asignado a curso/s exitosamente.");
                        location.reload();
