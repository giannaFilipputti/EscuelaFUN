                            ...
                            if (val.ruta == null) {
                                ...
                                for (var i = 0; i < strArr.length; i++) {
                                    ...
                                    if (i === strArr.length - 1) {
                                        ...
                                        botones += '<a class="uk-link-heading" href="' + strArr[i] + '" download="Tarea de ' + val.alumno + '"> ' + nombreA + '</a>';

                                    } else {

                                        botones += '<a class="uk-link-heading" href="' + strArr[i] + '" download="Tarea de ' + val.alumno + '"> ' + nombreA + '</a><br>';
