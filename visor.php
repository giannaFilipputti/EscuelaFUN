...
<body class="course-watch-page">
                                    ...
                                    <li <?php if ($modulo == $Elem['id']) {  ?> class="uk-open uk-activo" <?php  } ?>>
                                        ...
                                        <div class="uk-accordion-content">
                                            ...
                                            <ul class="course-video-list<?php if ($modulo == $Elem['id']) {  ?> highlight-watched<?php  } ?>">
                                                ...
                                                <?php if ((($Elem['examen_unico'] == 1 and $Elem['abierto'] == 1) or $authj->rowff['labor'] >= 6) && $cursos[0]['id'] !=12) {  ?>
                        ...
                        <div class="course-sidebar-container" data-simplebar>
                            ...
                            <ul class="course-video-list-section" uk-accordion>
                                ...
                                <ul class="uk-comment-list">
                                    ...
                                    <li id="div_comentarios" style="padding-bottom: 200px;"></li>
                                    ...
                                    <ul class="uk-list uk-list-striped">
                                        <?php foreach ($descargas as $desc) { ?>
                                           ...
                                           <!-- <li><a href="modulos/<?php echo $desc['modulo'] ?>_<?php echo $desc['id'] ?>.pdf"><?php echo $desc['nombre'] ?></a></li>-->
                                            ...
                                            <li><a href="descargar.php?id=<?php echo $desc['id']?>"><?php echo $desc['nombre'].".".$desc['ext'] ?></a></li>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var options01 = {
                id: <?php echo $cap_act[0]['video']; ?>
                };
               


                // <iframe src="https://player.vimeo.com/video/?autoplay=1" id="valor1" frameborder="0" uk-video="automute: false" allow="autoplay" allowfullscreen uk-responsive></iframe>
                var player1= new Vimeo.Player('{video01_name}', options01);
