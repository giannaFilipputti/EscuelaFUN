            ...
            <div class="uk-grid-large mt-4" uk-grid>
                        ...
                        <li>
                                ...
                                <div class="user-details-card">
                                    ...
                                    <div class="user-details-card-name">
                                        Álvaro Lara Leone <span> Ingeniero Civil Industrial UC <br>Módulo: Empoderamiento de personas que ejercen Dirigencia Deportiva</span>
                                    </div>
                                </div>
                                ...
                                <div class="user-details-card">
                                    ...
                                    <div class="user-details-card-name">
                                        Iván Manriquez Castillo <span> Ingeniero Comercial MBA en Dirección de Empresas<br> Módulo:  Fuentes de Financiamiento   </span>
                                    </div>
                                </div>

                                <div class="user-details-card">
                                    <div class="user-details-card-avatar">
                                        <img src="../assets/images/avatars/3.png" alt="">
                                    </div>
                                    <div class="user-details-card-name">
                                        Fernando Gonzalez Ibache <span> Magister en Condición Física y Salud <br>Vínculo y trabajo con la gestión local (Municipios)  </span>
                                    </div>
                                </div>

                                <div class="user-details-card">
                                    <div class="user-details-card-avatar">
                                        <img src="../assets/images/avatars/4.png" alt="">
                                    </div>
                                    <div class="user-details-card-name">
                                        Oscar Tapia Véliz <span> Abogado Máster en Derecho Deportivo<br>Módulo: Herramientas de Prevención y sanción de las conductas de acoso sexual, abuso sexual, discriminación y maltrato  </span>
                                    </div>
                                </div>
                        </li> -->
                ...
                <div class="uk-width-1-3@m">
                    <div class="course-card-trailer" uk-sticky="top: 10 ;offset:105 ; media: @m ; bottom:true">
                        ...
                        <img src="../assets/images/course/<?php echo $id ?>.jpg?v=2" alt="">
